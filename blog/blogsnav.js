let navtest = document.getElementById("navtest").innerHTML +=`
    <nav class="navbar navbar-expand-lg" style="box-shadow:3px 3px 3px 3px; background:url(../assets/images/bg.png);   ">
<a class="navbar-brand" href="index.html"><img src="../images/LOGO.jpg" height="50rem" width="50rem" style = "box-shadow:1px 1px 1px 1px black";></a>
